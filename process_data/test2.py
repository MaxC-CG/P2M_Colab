...
input_path = apath+"/data/cat_g.obj"
output_path = apath+"/data/cat_g.ply"
output_noise_path = apath+"/data/cat_g_noise.ply"
...
vs, normal=read_pts(output_path)
