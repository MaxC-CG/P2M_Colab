...
MANIFOLD_DIR = r'../Manifold/'  # path to manifold software (https://github.com/hjwdzh/Manifold)
...
class Options:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--iterations', type=int, metavar='N', default=6000, help='number of iterations to do')
        ...
        #
        parser.add_argument('--export-interval', type=int, metavar='N', default=50, help='export interval')
